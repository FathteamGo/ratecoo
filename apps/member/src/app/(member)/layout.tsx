...
import "../globals.css";
import { LayoutDashboard, FolderKanban, Settings, Star, Bell, User, Plus } from "lucide-react";
            ...
            <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 px-8 h-20 sticky top-0 z-10 shadow-sm flex items-center">
              <div className="flex items-center justify-between gap-8 w-full">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a 
                    href="/projects/new"
                    className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 font-medium text-sm flex items-center gap-2"
                  >
