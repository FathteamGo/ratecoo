            ...
            <div className="p-6 border-b border-slate-700 dark:border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 dark:text-slate-500">Member Portal</p>
                </div>
              </div>
              <ThemeToggle />
            </div>
            ...
            <div className="absolute bottom-0 w-72 p-4 border-t border-slate-700 dark:border-slate-200 bg-slate-900 dark:bg-white">
              <div className="flex items-center gap-3 px-4 py-3 bg-slate-800 dark:bg-slate-50 rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-slate-100 dark:text-slate-900 truncate">User Account</p>
                  <p className="text-xs text-slate-400 dark:text-slate-500 truncate">Free Plan</p>
                </div>
                <button className="p-2 hover:bg-slate-700 dark:hover:bg-slate-200 rounded-lg transition-colors">
          ...
          <main className="flex-1 overflow-auto">
            ...
            <header className="bg-slate-900 dark:bg-white border-b border-slate-700 dark:border-slate-200 px-8 py-4 sticky top-0 z-10 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-slate-100 dark:text-slate-900">Welcome Back!</h2>
                  <p className="text-sm text-slate-400 dark:text-slate-600">Manage your reviews and projects</p>
                </div>
