    ...
    <html lang="en">
      ...
      <body className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 antialiased relative">
        ...
        <div className="flex h-screen relative z-10">
          {/* Sidebar */}
          <aside className="w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 shadow-lg overflow-y-auto flex flex-col">
            ...
            <nav className="p-4 space-y-2">
              <a
                href="/"
                className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl shadow-lg shadow-blue-600/30 transition-all duration-300"
              >
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 p-4 mt-4">
              <p className="text-xs font-semibold text-slate-600 dark:text-slate-400 mb-2 px-4">Tools</p>
              <a
                href="/settings"
                className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-all duration-300"
              >
            ...
            <div className="absolute bottom-0 w-72 p-4 border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900">
              <div className="flex items-center gap-3 px-4 py-3 bg-slate-50 dark:bg-slate-800 rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-600 dark:text-slate-400 truncate">Super Admin</p>
                </div>
            ...
            <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 px-8 h-20 sticky top-0 z-10 shadow-sm flex items-center">
              <div className="flex items-center justify-between gap-8 w-full">
                <div className="flex-1">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white leading-tight">Platform Management</h2>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mt-0.5">Monitor and manage RateCoo platform</p>
                </div>
